...
armillaria_data = preprocessing_custom("https://zenodo.org/record/2591746/files/heterobasidion-armillaria.gpkg",
...
heterobasidion_data = preprocessing_custom("https://zenodo.org/record/2591746/files/heterobasidion-armillaria.gpkg",
                                           ...
                                           hail = hail_raw, precipitation = precipitation_sum,
                                           pisr = pisr, elevation = elevation, age = FALSE)
diplodia_data = preprocessing_custom("https://zenodo.org/record/2591746//files/diplodia-fusarium.gpkg",
...
fusarium_data = preprocessing_custom("https://zenodo.org/record/2591746/files/diplodia-fusarium.gpkg",
...
data_basque = st_read("https://zenodo.org/record/2591746/files/study-area.gpkg",
                      quiet = TRUE)
