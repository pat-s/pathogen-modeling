...
% link case study
One typical example for a spatial prediction approach in ecology is the detection of fungi infection on Monterey pines \citep{Iturritxa2014}.
...
In the present study we also introduced further predictors (probability of hail damage at trees, soil type, lithology type, pH) to possibly enhance the predictive power of the trained models.
...
\cite{Iturritxa2014} showed that the presence or absence of hail damage observed on trees explained best pathogen infections of trees in the Basque Country.
...
To avoid introducing collinearity, the following levels were removed from the data: soil type: "soils with clay enriched sub-soils". Lithology type: "surface deposits".
