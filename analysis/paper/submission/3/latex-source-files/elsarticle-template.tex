...
In the pre-selection for the non-spatial tuning setting, \texttt{mtry} values around 3 - 5 are favored because they provide a fair chance of having one of the strong autocorrelated predictors included in the selection.
