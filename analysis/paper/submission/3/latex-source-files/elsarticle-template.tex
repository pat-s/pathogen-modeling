...
For example, SVM showed substantial differences between the resampling methods chosen during tuning while the effect for KNN was negligible small.
...
By contrast, if the intention is to produce highly accurate spatial prediction maps, spatially tuned machine-learning models may be the better choice.
