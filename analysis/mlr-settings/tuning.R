...
wrapper_gam_fusarium_perf_sp = wrapper_custom(lrn_gam_fusarium_perf, ps_gam_diplodia_fusarium, spcv_inner_fiveF, tune_ctrl_gam_100_diplodia_fusarium)
...
wrapper_gam_fusarium_perf_nsp = wrapper_custom(lrn_gam_fusarium_perf, ps_gam_diplodia_fusarium, cv_inner_fiveF, tune_ctrl_gam_100_diplodia_fusarium)
