...
\begin{figure} [t!]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=0.7\textwidth] {iterations_vs_auroc.pdf}}
...
\begin{figure} [H]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[angle=90, height = 0.85\textheight] {tuning_effects_all_models.pdf}}
...
\begin{figure} [t!]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[width=\textwidth] {cv_boxplots_final.pdf}}
...
\begin{figure} [h]
	\begin{center}
		\makebox[\textwidth]{\includegraphics[angle=90, height = 0.6\textheight] {tuning_effects_appendix.pdf}}
